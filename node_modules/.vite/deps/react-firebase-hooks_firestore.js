...
import {
  ...
  jl,
  ql
} from "./chunk-VZ4JGIQP.js";
import "./chunk-V7ZRQZU2.js";
import {
  require_react
...
var useCollection = function(query, options) {
  ...
  (0, import_react.useEffect)(function() {
    ...
    var unsubscribe = (options === null || options === void 0 ? void 0 : options.snapshotListenOptions) ? jl(ref.current, options.snapshotListenOptions, setValue, setError) : jl(ref.current, setValue, setError);
    return function() {
      unsubscribe();
    };
  }, [ref.current]);
