...
function getBytesInternal(ref2, maxDownloadSizeBytes) {
  ...
  return ref2.storage.makeRequestWithTokens(requestInfo, newBytesConnection).then((bytes) => maxDownloadSizeBytes !== void 0 ? bytes.slice(0, maxDownloadSizeBytes) : bytes);
}
function getBlobInternal(ref2, maxDownloadSizeBytes) {
  ref2._throwIfRoot("getBlob");
  const requestInfo = getBytes$1(ref2.storage, ref2._location, maxDownloadSizeBytes);
  return ref2.storage.makeRequestWithTokens(requestInfo, newBlobConnection).then((blob) => maxDownloadSizeBytes !== void 0 ? blob.slice(0, maxDownloadSizeBytes) : blob);
}
